...
# Visando em resolver a situação, a diretora da escola contratou você 
# para desenvolver um programa que leia as notas da primeira e da segunda avaliação de um aluno. 
...
# solicitando as professoras que informe um código (1 ou 2) indicando 
