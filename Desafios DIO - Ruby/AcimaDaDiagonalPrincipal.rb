...
# Desafio - Acima da Diagonal Principal


# Leia um caractere maiúsculo, 
# que indica uma operação que deve ser 
# realizada e uma matriz M[12][12]. 
...
# A primeira linha de entrada contem 
# um único caractere Maiúsculo O ('S' ou 'M'), 
# indicando a operação (Soma ou Média) que 
# deverá ser realizada com os elementos da matriz. 
