...
# Desafio - Fibonacci em Vetor

# Nesse desafio você terá que desenvolver um programa que 
# leia um valor e apresente o número de Fibonacci correspondente 
# a este valor lido. Lembre que os 2 primeiros elementos da série 
...
# imprima a mensagem "Fib(N) = X", onde X é o N-ésimo termo da série de Fibonacci.
