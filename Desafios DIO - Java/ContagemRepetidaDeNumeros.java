...
// Neste desafio sua tarefa será ler vários números e em seguida dizer 
// quantas vezes cada número aparece, ou seja, deve-se escrever cada um 
...
// que indica a quantidade de valores que serão lidos para X 
// (1 ≤ N ≤ 2000) logo em seguida. Com certeza cada número não 
// aparecerá mais do que 20 vezes na entrada de dados.
	...
	public static void main(String[] args) {
        ...
        for (int i = 0; i < valores; i++) {
            ...
            if(numeros.containsKey(numero)) {
                ...
                var qnt = numeros.get(numero);
                numeros.put (numero, ++qnt);
