 ...
 * Logo de manhã muitas pessoas se deslocam para o polo de lazer da Parangaba, 
 * onde acontece uma feira, conhecida por ser a maior da cidade. 
 * Na feira da Parangaba você pode encontrar de tudo.
 * Todos os domingos, Bino faz compras na feira. 
 * Ele sempre marca com seu amigo Cino de se encontrarem no 
 * terminal de ônibus da Parangaba às 8h, para irem juntos 
 * comprar na feira. 
 ...
 * Cada caso de tese contém uma única linha contendo 
 * um horário H (5:00 ≤ H ≤ 9:00) que Bino acordou. 
 * A entrada termina com final de arquivo (EOF).
 * 
 * Saída -
 * Para cada caso de teste, 
 * imprima "Atraso maximo: X" (sem aspas), X 
 * indica o atraso maximo (em minutos) de Bino 
 * no encontro com Cino.
 * 
 */
